...
var store map[uint8]ControlStoreOutput = map[uint8]ControlStoreOutput{
	...
	25: {COND: COND_MEMREADY, J: 25, DatapathSignals: Signals{MioEN: NoYesSig_YES, LdMDR: LoadSig_LOAD, DataSize: WORD}},
	26: {},
	27: {J: 18, DatapathSignals: Signals{DataSize: WORD, GateMDR: NoYesSig_YES, LdREG: LoadSig_LOAD, LdCC: LoadSig_LOAD}},
	28: {COND: COND_MEMREADY, J: 28, DatapathSignals: Signals{MioEN: NoYesSig_YES, LdMDR: LoadSig_LOAD, DrMUX: DRMUX_R7, GatePC: NoYesSig_YES, LdREG: LoadSig_LOAD}},
	29: {COND: COND_MEMREADY, J: 29, DatapathSignals: Signals{Rw: RW_RD, DataSize: BYTE, MioEN: NoYesSig_YES, LdMDR: LoadSig_LOAD}},
	...
	33: {COND: COND_MEMREADY, J: 33, DatapathSignals: Signals{Rw: RW_RD, DataSize: WORD, MioEN: NoYesSig_YES, LdMDR: LoadSig_LOAD}},
	34: {},
